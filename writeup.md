...
##### 3. Bilinear upsampling decoder layer
...
##### 4. Convolutional layer with softmax
...
Fully convolutional network (with decoder) perforems identification pixel-wise and can detect multiple objects and show their spatial locations. This is needed to obtain location of chosen person in the project. The network is fed with the data from drone camera and its object is to show which pixels contain the target object. For this purpouse a fully convolutional network is built. The architecture of the network is shown in the figure in section 2. of writeup. The network consists of 3 blocks: encoder block, 1 to 1 convolutional layer and decoder block. 
